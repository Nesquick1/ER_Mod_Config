...
$Event(0, Default, function() {
    ...
    InitializeEvent(0, 1700, 0);
    InitializeEvent(0, 1055550025, 0);
});
...
$Event(1055550025, Default, function() {
    if (!EventFlag(1055550000)) {
        WaitFor(HPRatio(10000) <= 0);
        if (TimeOfDayInRange(0, 0, 0, 0, 59, 59)) {
            SetEventFlagID(1055550001, ON);
        } else if (TimeOfDayInRange(1, 0, 0, 1, 59, 59)) {
            SetEventFlagID(1055550002, ON);
        } else if (TimeOfDayInRange(2, 0, 0, 2, 59, 59)) {
            SetEventFlagID(1055550003, ON);
        } else if (TimeOfDayInRange(3, 0, 0, 3, 59, 59)) {
            SetEventFlagID(1055550004, ON);
        } else if (TimeOfDayInRange(4, 0, 0, 4, 59, 59)) {
            SetEventFlagID(1055550005, ON);
        } else if (TimeOfDayInRange(5, 0, 0, 5, 59, 59)) {
            SetEventFlagID(1055550006, ON);
        } else if (TimeOfDayInRange(6, 0, 0, 6, 59, 59)) {
            SetEventFlagID(1055550007, ON);
        } else if (TimeOfDayInRange(7, 0, 0, 7, 59, 59)) {
            SetEventFlagID(1055550008, ON);
        } else if (TimeOfDayInRange(8, 0, 0, 8, 59, 59)) {
            SetEventFlagID(1055550009, ON);
        } else if (TimeOfDayInRange(9, 0, 0, 9, 59, 59)) {
            SetEventFlagID(1055550010, ON);
        } else if (TimeOfDayInRange(10, 0, 0, 10, 59, 59)) {
            SetEventFlagID(1055550011, ON);
        } else if (TimeOfDayInRange(11, 0, 0, 11, 59, 59)) {
            SetEventFlagID(1055550012, ON);
        } else if (TimeOfDayInRange(12, 0, 0, 12, 59, 59)) {
            SetEventFlagID(1055550013, ON);
        } else if (TimeOfDayInRange(13, 0, 0, 13, 59, 59)) {
            SetEventFlagID(1055550014, ON);
        } else if (TimeOfDayInRange(14, 0, 0, 14, 59, 59)) {
            SetEventFlagID(1055550015, ON);
        } else if (TimeOfDayInRange(15, 0, 0, 15, 59, 59)) {
            SetEventFlagID(1055550016, ON);
        } else if (TimeOfDayInRange(16, 0, 0, 16, 59, 59)) {
            SetEventFlagID(1055550017, ON);
        } else if (TimeOfDayInRange(17, 0, 0, 17, 59, 59)) {
            SetEventFlagID(1055550018, ON);
        } else if (TimeOfDayInRange(18, 0, 0, 18, 59, 59)) {
            SetEventFlagID(1055550019, ON);
        } else if (TimeOfDayInRange(19, 0, 0, 19, 59, 59)) {
            SetEventFlagID(1055550020, ON);
        } else if (TimeOfDayInRange(20, 0, 0, 20, 59, 59)) {
            SetEventFlagID(1055550021, ON);
        } else if (TimeOfDayInRange(21, 0, 0, 21, 59, 59)) {
            SetEventFlagID(1055550022, ON);
        } else if (TimeOfDayInRange(22, 0, 0, 22, 59, 59)) {
            SetEventFlagID(1055550023, ON);
        } else if (TimeOfDayInRange(23, 0, 0, 23, 59, 59)) {
            SetEventFlagID(1055550024, ON);
        }
        SetEventFlagID(1055550000, ON);
        EndEvent();
    }
    if (EventFlag(1055550001)) {
        SetCurrentTime(1, 0, 0, false, false, false, 0, 0, 0);
    } else if (EventFlag(1055550002)) {
        SetCurrentTime(2, 0, 0, false, false, false, 0, 0, 0);
    } else if (EventFlag(1055550003)) {
        SetCurrentTime(3, 0, 0, false, false, false, 0, 0, 0);
    } else if (EventFlag(1055550004)) {
        SetCurrentTime(4, 0, 0, false, false, false, 0, 0, 0);
    } else if (EventFlag(1055550005)) {
        SetCurrentTime(5, 0, 0, false, false, false, 0, 0, 0);
    } else if (EventFlag(1055550006)) {
        SetCurrentTime(6, 0, 0, false, false, false, 0, 0, 0);
    } else if (EventFlag(1055550007)) {
        SetCurrentTime(7, 0, 0, false, false, false, 0, 0, 0);
    } else if (EventFlag(1055550008)) {
        SetCurrentTime(8, 0, 0, false, false, false, 0, 0, 0);
    } else if (EventFlag(1055550009)) {
        SetCurrentTime(9, 0, 0, false, false, false, 0, 0, 0);
    } else if (EventFlag(1055550010)) {
        SetCurrentTime(10, 0, 0, false, false, false, 0, 0, 0);
    } else if (EventFlag(1055550011)) {
        SetCurrentTime(11, 0, 0, false, false, false, 0, 0, 0);
    } else if (EventFlag(1055550012)) {
        SetCurrentTime(12, 0, 0, false, false, false, 0, 0, 0);
    } else if (EventFlag(1055550013)) {
        SetCurrentTime(13, 0, 0, false, false, false, 0, 0, 0);
    } else if (EventFlag(1055550014)) {
        SetCurrentTime(14, 0, 0, false, false, false, 0, 0, 0);
    } else if (EventFlag(1055550015)) {
        SetCurrentTime(15, 0, 0, false, false, false, 0, 0, 0);
    } else if (EventFlag(1055550016)) {
        SetCurrentTime(16, 0, 0, false, false, false, 0, 0, 0);
    } else if (EventFlag(1055550017)) {
        SetCurrentTime(17, 0, 0, false, false, false, 0, 0, 0);
    } else if (EventFlag(1055550018)) {
        SetCurrentTime(18, 0, 0, false, false, false, 0, 0, 0);
    } else if (EventFlag(1055550019)) {
        SetCurrentTime(19, 0, 0, false, false, false, 0, 0, 0);
    } else if (EventFlag(1055550020)) {
        SetCurrentTime(20, 0, 0, false, false, false, 0, 0, 0);
    } else if (EventFlag(1055550021)) {
        SetCurrentTime(21, 0, 0, false, false, false, 0, 0, 0);
    } else if (EventFlag(1055550022)) {
        SetCurrentTime(22, 0, 0, false, false, false, 0, 0, 0);
    } else if (EventFlag(1055550023)) {
        SetCurrentTime(23, 0, 0, false, false, false, 0, 0, 0);
    } else if (EventFlag(1055550024)) {
        SetCurrentTime(0, 0, 0, false, false, false, 0, 0, 0);
    }
    BatchSetEventFlags(1055550000, 1055550024, OFF);
    RestartEvent();
});
...
$Event(820, Default, function(X0_4) {
    DisableNetworkSync();
    SetEventFlagID(X0_4, OFF);
    WaitFor(WeatherActive(Weather.Default, 0, 0));
...
$Event(839, Restart, function() {
    DisableNetworkSync();
    GotoIf(L0, WeatherActive(Weather.Default, 0, 0));
    GotoIf(L1, 
    ...
    GotoIf(L2, 
        WeatherActive(Weather.Default, 0, 0)
            ...
            || WeatherActive(Weather.Default, 0, 0)
            || WeatherActive(Weather.Default, 0, 0));
    GotoIf(L3, WeatherActive(Weather.Default, 0, 0) || WeatherActive(Weather.Default, 0, 0));
    GotoIf(L4, WeatherActive(Weather.Default, 0, 0) || WeatherActive(Weather.Default, 0, 0));
    GotoIf(L5, WeatherActive(Weather.Default, 0, 0) || WeatherActive(Weather.Default, 0, 0));
...
L3:
    ...
    SetEventFlagID(574, OFF);
    SetEventFlagID(575, OFF);
    WaitFor(!(WeatherActive(Weather.Default, 0, 0) || WeatherActive(Weather.Default, 0, 0)));
    RestartEvent();
L4:
    SetEventFlagID(570, OFF);
    SetEventFlagID(571, OFF);
...
$Event(901, Restart, function() {
    ...
    if (!EventFlag(1054539201)) {
        if (!(PlayerHasArmorEquipped(ArmorType.Head, 150000, 255)
            || PlayerHasArmorEquipped(ArmorType.Head, 640000, 255)
            || PlayerHasArmorEquipped(ArmorType.Head, 910000, 255)
            || PlayerHasArmorEquipped(ArmorType.Head, 760000, 255)
            || PlayerHasArmorEquipped(ArmorType.Head, 440000, 255)
            || PlayerHasArmorEquipped(ArmorType.Head, 470000, 255)
            || PlayerHasArmorEquipped(ArmorType.Head, 820000, 255)
            || PlayerHasArmorEquipped(ArmorType.Head, 1010000, 255)
            || PlayerHasArmorEquipped(ArmorType.Head, 1760000, 255)
            || PlayerHasArmorEquipped(ArmorType.Head, 1770000, 255)
            || PlayerHasArmorEquipped(ArmorType.Head, 1780000, 255)
            || PlayerHasArmorEquipped(ArmorType.Head, 2010000, 255)
            || PlayerHasArmorEquipped(ArmorType.Body, 330100, 255)
            || PlayerHasArmorEquipped(ArmorType.Body, 1810100, 255)
            || PlayerHasArmorEquipped(ArmorType.Body, 1811100, 255))) {
        ...
        WaitFixedTimeRealFrames(1);
        PlayCutsceneToPlayerWithWeatherAndTime(60540010, CutscenePlayMode.SkippableWithFadeOutSkip, 10000, 2, Weather.Default, 0, true, 6, 30, 0);
        WaitFixedTimeRealFrames(1);
        SetEventFlagID(9001, OFF);
        EndEvent();
    }
L1:
    ...
    WaitFixedTimeRealFrames(1);
    PlayCutsceneToPlayerWithWeatherAndTime(60540011, CutscenePlayMode.SkippableWithFadeOutSkip, 10000, 2, Weather.Default, 0, true, 6, 30, 0);
    WaitFixedTimeRealFrames(1);
    SetEventFlagID(9001, OFF);
    EndEvent();
});
...
L9:
    ...
    if (!MapLoaded(60, 52, 39, 0)) {
        PlayCutsceneToPlayerWithWeatherAndTime(60510011, CutscenePlayMode.Skippable, 10000, 2, Weather.Cloudless, 0, true, 22, 30, 0);
    } else {
        PlayCutsceneToPlayerWithWeatherAndTime(60510010, CutscenePlayMode.Skippable, 10000, 2, Weather.Cloudless, 0, true, 22, 30, 0);
    }
    WaitFixedTimeRealFrames(1);
...
$Event(936, Default, function(X0_4, X4_4, X8_4, X12_4, X16_4, X20_4, X28_4) {
    WaitFor(
        !(HasMultiplayerState(MultiplayerState.Multiplayer)
            || HasMultiplayerState(MultiplayerState.MultiplayerPending))
            && EventFlag(X8_4));
    ...
    SetEventFlagID(9021, ON);
    PlayCutsceneToPlayerAndWarpWithWeatherAndTime(X0_4, CutscenePlayMode.Skippable, X16_4, X12_4, 10000, X20_4, false, false, Weather.Default, X28_4, false, 0, 0, 0);
    WaitFixedTimeRealFrames(1);
    PlayCutsceneToPlayer(X4_4, CutscenePlayMode.SkippableWithFadeOutSkip, 10000);
    WaitFixedTimeRealFrames(1);
    RestartEvent();
...
$Event(950, Restart, function() {
    ...
    flag = EventValue(955, 1) == 1;
    flag2 = EventValue(955, 1) >= 1;
...
$Event(960, Default, function(X0_4) {
    EndIf(EventFlag(951));
    EndIf(EventFlag(X0_4));
    WaitFor(EventFlag(955) || EventFlag(X0_4));
    EndIf(EventFlag(951));
